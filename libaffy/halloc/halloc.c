...
/*      2012-09-19 Eric A. Welsh: called halloc() with NULL instead of 0
 *       since 0 is not technically NULL, and valgrind was upset
 *
...
{
	return halloc(NULL, len);
}

void * h_calloc(size_t n, size_t len)
{
	void * ptr = halloc(NULL, len*=n);
